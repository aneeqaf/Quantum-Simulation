...
def TrialRunEval(report_file, num_CZ, start_time, end_time, dfs_len = 0):
	...
	if rep_time == "":
		...
		return int(num_CZ), mem_val, short_path, dfs_len


def PerformTrialRun(commandH, commandV, num_cz, dfs_len = 0):
